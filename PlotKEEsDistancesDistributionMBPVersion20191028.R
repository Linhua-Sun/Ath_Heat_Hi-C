...
#pdf(file = paste(Args[1], "_boxplot_vertical_noNA.pdf", sep = ""),height = 10,width = 6)
ggplot(mtest[value != 0], aes(x = variable, y = value, fill = NA)) +
    stat_boxplot(geom = 'errorbar', width = 0.3) +
    geom_jitter(size = 1, aes(color = variable)) +
